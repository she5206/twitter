...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(showLoginView) name:UserDidLogoutNotification object:nil];
...
- (void)showTimelineView{
    ...
    TimelineViewController* loginViewController = [mainstoryboard instantiateViewControllerWithIdentifier:@"Timeline"];
